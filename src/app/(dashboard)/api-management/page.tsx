    ...
    <div className="p-6 bg-white min-h-full">
      ...
      <section className="mb-6">
        ...
        {loading ? (
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-10 text-center">
            ...
            <h3 className="text-sm font-medium text-gray-900 mb-1">No webhooks configured</h3>
              ...
              <tbody className="divide-y divide-gray-100">
                {webhooks.map((wh) => (
                  <tr key={wh.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-4 py-3 text-sm font-mono text-gray-900 truncate max-w-[250px]">{wh.url}</td>
      ...
      <section>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8 text-center">
          ...
          <h3 className="text-sm font-medium text-gray-900 mb-1">Request logs</h3>
