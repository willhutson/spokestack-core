...
export default function MyModulesPage() {
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-lg font-semibold text-gray-900">My Published Modules</h1>
      ...
      {modules.length > 0 && (
        <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
          {/* Table header */}
          <div className="grid grid-cols-[2fr_1fr_0.7fr_0.8fr_0.8fr_0.7fr_1fr_0.8fr] gap-2 px-5 py-3 bg-gray-50 border-b border-gray-200 text-xs font-medium text-gray-500 uppercase tracking-wide">
            <span>Name</span>
            <span>Status</span>
            <span>Version</span>
            <span>Installs</span>
          ...
          {modules.map((mod) => (
            <div key={mod.id}>
              <div
                ...
                className={`grid grid-cols-[2fr_1fr_0.7fr_0.8fr_0.8fr_0.7fr_1fr_0.8fr] gap-2 px-5 py-3.5 border-b border-gray-100 cursor-pointer hover:bg-gray-50 transition-colors items-center ${
                  expandedId === mod.id ? "bg-indigo-50/50" : ""
                }`}
              >
                <div className="min-w-0">
                  <p className="text-sm font-medium text-gray-900 truncate">{mod.name}</p>
                  <p className="text-xs text-gray-400 truncate">{mod.shortDescription}</p>
                </div>
                <div>
                  <span
                ...
                <span className="text-sm text-gray-600">{mod.version}</span>
                <span className="text-sm text-gray-600">{mod.installCount.toLocaleString()}</span>
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-xs text-gray-400">({mod.reviewCount})</span>
                </div>
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-xs text-gray-500">{mod.qualityScore}</span>
                </div>
                <span className="text-sm text-gray-600">{renderPricing(mod.pricing)}</span>
              ...
              {expandedId === mod.id && (
                <div className="px-5 py-4 bg-indigo-50/30 border-b border-gray-100">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-4 gap-3 mb-4">
                        <div className="bg-white border border-gray-200 rounded-xl p-4">
                          <p className="text-xs text-gray-500 mb-1">Total Installs</p>
                          <p className="text-lg font-semibold text-gray-900">
                            {analytics[mod.id].totalInstalls.toLocaleString()}
                          </p>
                        </div>
                        <div className="bg-white border border-gray-200 rounded-xl p-4">
                          <p className="text-xs text-gray-500 mb-1">Active Installs</p>
                          <p className="text-lg font-semibold text-gray-900">
