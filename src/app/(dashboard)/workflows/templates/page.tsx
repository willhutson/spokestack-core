      ...
      <div className="p-6 h-full flex flex-col bg-[var(--bg-base)]">
        ...
        {loading ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center">
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-1">No templates found</h2>
            ...
            {filtered.map((template) => (
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span
                    className={`px-2 py-0.5 text-xs font-medium rounded-full ${
                      CATEGORY_COLORS[template.category] || "bg-[var(--bg-surface)] text-[var(--text-secondary)]"
                    }`}
                  >
                    {template.category}
                  </span>
                ...
                <button
                  ...
                  className="w-full px-3 py-2 text-xs font-medium text-[var(--accent)] bg-[var(--accent-subtle)] border border-[var(--accent)] rounded-lg hover:bg-[var(--accent-subtle)] transition-colors"
                >
                  Install
                </button>
              </div>
